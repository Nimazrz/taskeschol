"""
Django settings for taskeschol project.
...
SECRET_KEY = 'django-insecure-5^gb=2fvbwkiup#^9v3e^sb@9dgd!*2b4ro@1oi*9&tq!!oq1%'
...
WSGI_APPLICATION = 'taskeschol.wsgi.application'
